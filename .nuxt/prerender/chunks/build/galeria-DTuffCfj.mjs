...
import { ref, computed, mergeProps, withCtx, createVNode, useSSRContext, defineComponent, inject, openBlock, createElementBlock, renderSlot, createCommentVNode, createElementVNode } from 'file:///Applications/XAMPP/xamppfiles/htdocs/SymbolGymAPI/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrRenderTeleport } from 'file:///Applications/XAMPP/xamppfiles/htdocs/SymbolGymAPI/node_modules/vue/server-renderer/index.mjs';
...
const v = ["width", "height", "fill", "transform"], V$3 = { key: 0 }, H$3 = /* @__PURE__ */ createElementVNode("path", { d: "M140,32V64a12,12,0,0,1-24,0V32a12,12,0,0,1,24,0Zm33.25,62.75a12,12,0,0,0,8.49-3.52L204.37,68.6a12,12,0,0,0-17-17L164.77,74.26a12,12,0,0,0,8.48,20.49ZM224,116H192a12,12,0,0,0,0,24h32a12,12,0,0,0,0-24Zm-42.26,48.77a12,12,0,1,0-17,17l22.63,22.63a12,12,0,0,0,17-17ZM128,180a12,12,0,0,0-12,12v32a12,12,0,0,0,24,0V192A12,12,0,0,0,128,180ZM74.26,164.77,51.63,187.4a12,12,0,0,0,17,17l22.63-22.63a12,12,0,1,0-17-17ZM76,128a12,12,0,0,0-12-12H32a12,12,0,0,0,0,24H64A12,12,0,0,0,76,128ZM68.6,51.63a12,12,0,1,0-17,17L74.26,91.23a12,12,0,0,0,17-17Z" }, null, -1), y = [
  ...
  setup(d) {
    const s = d, c = inject("weight", "regular"), Z2 = inject("size", "1em"), h = inject("color", "currentColor"), _ = inject("mirrored", false), o = computed(() => {
      var _a;
      return (_a = s.weight) != null ? _a : c;
    }), i = computed(() => {
      var _a;
      return (_a = s.size) != null ? _a : Z2;
    }), M2 = computed(() => {
      var _a;
      return (_a = s.color) != null ? _a : h;
    }), m = computed(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
...
const w$2 = ["width", "height", "fill", "transform"], H$2 = { key: 0 }, M$2 = /* @__PURE__ */ createElementVNode("path", { d: "M228,128a12,12,0,0,1-12,12H69l51.52,51.51a12,12,0,0,1-17,17l-72-72a12,12,0,0,1,0-17l72-72a12,12,0,0,1,17,17L69,116H216A12,12,0,0,1,228,128Z" }, null, -1), k$2 = [
  ...
  setup(d) {
    const l = d, c = inject("weight", "regular"), _ = inject("size", "1em"), h = inject("color", "currentColor"), u = inject("mirrored", false), s = computed(() => {
      var _a;
      return (_a = l.weight) != null ? _a : c;
    }), i = computed(() => {
      var _a;
...
const w$1 = ["width", "height", "fill", "transform"], H$1 = { key: 0 }, M$1 = /* @__PURE__ */ createElementVNode("path", { d: "M224.49,136.49l-72,72a12,12,0,0,1-17-17L187,140H40a12,12,0,0,1,0-24H187L135.51,64.48a12,12,0,0,1,17-17l72,72A12,12,0,0,1,224.49,136.49Z" }, null, -1), A$1 = [
  ...
  setup(d) {
    const l = d, c = inject("weight", "regular"), h = inject("size", "1em"), _ = inject("color", "currentColor"), u = inject("mirrored", false), s = computed(() => {
      var _a;
      return (_a = l.weight) != null ? _a : c;
    }), r = computed(() => {
      var _a;
      return (_a = l.size) != null ? _a : h;
    }), p = computed(() => {
      var _a;
      return (_a = l.color) != null ? _a : _;
    }), g = computed(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : u ? "scale(-1, 1)" : void 0);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="container my-16"><h2 class="mb-8 text-white text-3xl uppercase font-teko text-white"> GAL\xC9RIA </h2><div class="leading-loose"><p class="pb-6 text-white"> A Symbol Gym Orosh\xE1za t\xF6bb mint egy egyszer\u0171 edz\u0151terem \u2013 ez egy olyan k\xF6z\xF6ss\xE9gi t\xE9r, ahol az emberek inspir\xE1ci\xF3t \xE9s t\xE1mogat\xE1st tal\xE1lnak az eg\xE9szs\xE9gesebb, er\u0151sebb \xE9let fel\xE9 vezet\u0151 \xFAton. Itt mindenki megtapasztalhatja, mit jelent t\xFAll\xE9pni a saj\xE1t hat\xE1rain, legyen sz\xF3 fizikai vagy ment\xE1lis kih\xEDv\xE1sokr\xF3l. Edz\xE9seink nemcsak a testet form\xE1lj\xE1k, hanem a lelket is er\u0151s\xEDtik, hogy kitart\xE1ssal \xE9s elsz\xE1nts\xE1ggal n\xE9zhess szembe a mindennapok pr\xF3b\xE1ival. Az itt megszerzett er\u0151 \xE9s kitart\xE1s az \xE9let minden ter\xFClet\xE9n \xE9rezteti hat\xE1s\xE1t. </p><p class="pb-6 text-white"> Az edz\xE9seink sor\xE1n a leg\xFAjabb technol\xF3gi\xE1kat \xE9s m\xF3dszereket alkalmazzuk, hogy a fejl\u0151d\xE9sed minden szempontb\xF3l optim\xE1lis legyen. A Symbol Gym falai k\xF6z\xF6tt minden perc \xE9rt\xE9kes, \xE9s minden egyes gyakorlat k\xF6zelebb visz a kit\u0171z\xF6tt c\xE9lokhoz. A fejleszt\xE9sre sz\xE1nt figyelem \xE9s az el\xE9rt eredm\xE9nyek \xF6r\xF6me egyar\xE1nt hozz\xE1j\xE1rulnak ahhoz, hogy az edz\xE9s ne csak k\xF6telezetts\xE9g, hanem val\xF3di \xE9letm\xF3d legyen. </p><p class="text-white"> V\xE1runk t\xE9ged is a Symbol Gym Orosh\xE1z\xE1ban, ahol egy csal\xE1dias k\xF6z\xF6ss\xE9gben, t\xE1mogat\xF3 l\xE9gk\xF6rben dolgozhatsz \xF6nmagad legjobb v\xE1ltozat\xE1nak megteremt\xE9s\xE9n. \xC9ld \xE1t a v\xE1ltoz\xE1st, \xE9rezd az er\u0151t \xE9s tal\xE1ld meg azt az \xF6nbizalmat, ami val\xF3ban megv\xE1ltoztatja az \xE9letedet! L\xE9gy r\xE9szese ennek az inspir\xE1l\xF3 utaz\xE1snak, ahol nemcsak tested, hanem lelked is \xFAj szintre emelkedik. Csatlakozz hozz\xE1nk, \xE9s tapasztald meg, mit jelent az igazi csapat, ahol egy\xFCtt \xE9r\xFCnk el csod\xE1latos eredm\xE9nyeket! </p></div><div class="grid grid-cols-1 gap-4 pt-10 md:grid-cols-2 lg:grid-cols-3"><!--[-->`);
      ssrRenderList(galleryImages.value, (image, index) => {
        _push(`<div class="relative group"><div><div class="relative w-full h-64 mb-4 overflow-hidden transition-shadow duration-300 cursor-pointer group-hover:shadow-xl"><img${ssrRenderAttr("src", image.src)}${ssrRenderAttr("alt", image.alt)} class="object-cover w-full h-full" loading="lazy"><div class="absolute inset-0 flex items-center justify-center transition-opacity duration-300 bg-black bg-opacity-0 cursor-pointer group-hover:bg-opacity-20"><span class="text-white transition-opacity duration-300 opacity-0 group-hover:opacity-100">Megtekint\xE9s</span></div></div></div></div>`);
      });
      _push(`<!--]--></div>`);
...
//# sourceMappingURL=galeria-DTuffCfj.mjs.map
