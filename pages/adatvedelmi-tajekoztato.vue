...
<template>
  <section>
    <div class="subpage-content container">
      <h5 class="text-3xl uppercase font-teko text-white">
        Adatkezelési Tájékoztató
      </h5>

      <p class="text-white">Elfogadás dátuma: 2024.11.04</p>

      <h5 class="text-3xl uppercase font-teko text-white">1. ADATKEZELŐ</h5>
      <p class="text-white">symbolgym2020@gmail.com</p>
