import { ssrRenderAttrs } from 'file:///Applications/XAMPP/xamppfiles/htdocs/SymbolGymAPI/node_modules/vue/server-renderer/index.mjs';
import { u as useHead } from './server.mjs';
import { useSSRContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/SymbolGymAPI/node_modules/vue/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(_attrs)}><div class="subpage-content subpage-content--mobilew container"><h2 class="text-3xl uppercase font-teko text-white"> \xCDRJON NEK\xDCNK, HAMAR V\xC1LASZOLUNK </h2><p class="text-white supage-content__p"> Amennyiben b\xE1rmilyen k\xE9rd\xE9se mer\xFClne fel, ne habozzon kapcsolatba l\xE9pni vel\xFCnk! \xCDrjon nek\xFCnk b\xE1tran, \xE9s csapatunk igyekszik a lehet\u0151 legr\xF6videbb id\u0151n bel\xFCl v\xE1laszolni minden \xE9rdekl\u0151d\xE9sre. V\xE1rjuk, hogy halljunk \xD6n fel\u0151l! </p><h2 class="text-3xl uppercase font-teko text-white"> Kapcsolatfelv\xE9teli \u0171rlap: </h2><ul class="supage-content__ul"><li class="text-white"><strong class="supage-content__ul__li__strong">N\xE9v:</strong> K\xE9rj\xFCk, adja meg a nev\xE9t, hogy szem\xE9lyre szabottan v\xE1laszolhassunk. </li><li class="text-white"><strong class="supage-content__ul__li__strong">Email c\xEDm:</strong> Ide k\xFCldj\xFCk a v\xE1laszunkat \xE9s minden tov\xE1bbi inform\xE1ci\xF3t. </li><li class="text-white"><strong class="supage-content__ul__li__strong">Telefonsz\xE1m:</strong>Ha telefonon szeretne kapcsolatba l\xE9pni, k\xE9rj\xFCk, adja meg telefonsz\xE1m\xE1t. </li><li class="text-white"><strong class="supage-content__ul__li__strong">\xDCzenet:</strong> \xCDrja le k\xE9rd\xE9s\xE9t vagy k\xE9r\xE9s\xE9t r\xE9szletesen. </li></ul><p class="text-white"><i class="supage-content__p__i">A k\xFCld\xE9s gombra kattintva automatikusan elfogadja az Adatv\xE9delmi Szab\xE1lyzatot. </i></p></div></section>`);
    };
  }
};
...
//# sourceMappingURL=kapcsolat-BITuFgZI.mjs.map
